...
2. Match the established immediate-parent identity from harness metadata or an explicit `Parent name` against live sessions. If neither exists, treat routing as unresolved.
