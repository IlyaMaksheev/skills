...
| `TASK-BANK.md` | Persisted scheduling graph and state | Read fully only for requested graph-backed work; then load `/skill:delegating-work` and `../delegating-work/task-bank-orchestration.md` when delegating graph-backed execution is part of the assignment. |
